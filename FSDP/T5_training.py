...
def fsdp_main(args):
    ...
    #dataset = load_dataset('wikihow', 'all', data_dir='data/', download_mode='force_redownload')
    dataset = load_dataset("csv", data_files="data/wikihowAll.csv")
    # Se "validation" non esiste, crea uno split manuale (80% train, 20% validation)
    if "validation" not in dataset:
        dataset = dataset["train"].train_test_split(test_size=0.2)
        dataset["validation"] = dataset["test"]
        print("Dataset split manually:", dataset)
