...
class Trainer:
    def __init__(
        ...
        self.model = DDP(model, device_ids=[gpu_id]) # wrappare dentro ddp
...
def prepare_dataloader(dataset: Dataset, batch_size: int):
    return DataLoader(
        ...
        pin_memory=True,
        shuffle=False,
        sampler = DistributedSampler(dataset)  # ora il dataloader deve distribuire tra le GPU, e non deve fare shuffle
